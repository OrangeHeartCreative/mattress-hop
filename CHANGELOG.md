...
- Temporarily experimented with a charge jump, but reverted to single fixed jump.
...
If you'd like this written into a per-commit changelog or a single release note, I can prepare a commit message and a brief release description.